...
(function() {
  ...
  Preso = (function() {
    ...
    Preso.prototype.createSlide = function(contents) {
      ...
      id || (id = classes[0] || "");
      return "<section data-state=\"" + (id.replace(/\s/g, '')) + "\" class=\"hbox " + class_str + "\" data-markdown>" + contents + "</section>";
    };
    ...
    Preso.prototype.addDebugElement = function() {
      ...
      $debug_el = '<div class="slide-boundry" style="position:absolute;left:50%;margin-left:-480px;top:50%;margin-top:-350px;border:1px solid #a00;height:700px;width:960px" />';
